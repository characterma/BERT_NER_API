...
class ModelPath(Path):
    ...
    Example:
        ...
        models/:  /Users/shemyu/Documents/Wisers/py-api-project/ner-starbucks-api/src/models
        >>> data_txt = models_dirt / "data.txt"
        >>> print("path of data.txt: ", data_txt)
        path of data.txt:  /Users/shemyu/Documents/Wisers/py-api-project/ner-starbucks-api/src/models/data.txt
        ...
        path of archi.sample:  /Users/shemyu/Documents/Wisers/py-api-project/ner-starbucks-api/src/models/tiny_model.sample/archi.sample
